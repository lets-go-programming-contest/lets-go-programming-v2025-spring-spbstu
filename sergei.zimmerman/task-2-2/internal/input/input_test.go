...
func TestReadInput(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "Too many dishes",
			input:       "10001\n1 2 3\n1\n",
			expectError: true,
		},
		{
			name:        "Invalid preference value - too high",
			input:       "3\n3 10001 1\n1\n",
			expectError: true,
		},
		{
			name:        "Invalid preference value - too low",
			input:       "3\n3 -10001 1\n1\n",
			expectError: true,
		},
		{
			name:        "K out of range - too high",
			input:       "3\n3 2 1\n4\n",
			expectError: true,
		},
		{
			name:        "K out of range - too low",
			input:       "3\n3 2 1\n0\n",
			expectError: true,
		},
		{
			name:        "Mismatch in number of dishes",
			input:       "5\n1 2 3\n1\n",
			expectError: true,
		},
		{
